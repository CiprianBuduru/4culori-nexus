        ...
        <div style="background: #f8fafc; padding: 30px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 10px 10px;">
          ...
          <div style="background: white; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px; margin-bottom: 20px;">
            ...
            <div style="display: grid; gap: 10px;">
              ...
              ${operationName ? `
                <div style="display: flex; align-items: center; gap: 10px;">
                  <span style="color: #64748b;">⚙️ Operațiune:</span>
                  <span style="color: #1e293b; font-weight: 500;">${operationName}</span>
                </div>
              ` : ''}
              ...
              <div style="display: flex; align-items: center; gap: 10px;">
                ...
                <span style="color: #1e293b; font-weight: 500;">
                  ${new Date(startDate).toLocaleDateString('ro-RO')} - ${new Date(endDate).toLocaleDateString('ro-RO')}
                </span>
              </div>
            </div>
          </div>
          ...
          <p style="color: #64748b; font-size: 14px; margin-top: 30px;">
            Acest email a fost trimis automat de sistemul de management al producției 4culori.
          </p>
        </div>
      </div>
    `;
